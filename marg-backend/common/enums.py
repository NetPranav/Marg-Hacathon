...
class ShipmentStatus(models.TextChoices):
    ...
    DOCK_REQUESTED = 'DOCK_REQUESTED', 'Dock Requested'
    DOCK_APPROVED = 'DOCK_APPROVED', 'Dock Approved'
    IN_TRANSIT = 'IN_TRANSIT', 'In Transit'
...
class ShipmentEventType(models.TextChoices):
    ...
    DOCK_REQUESTED = 'DOCK_REQUESTED', 'Dock Requested'
    DOCK_REQUEST_REJECTED = 'DOCK_REQUEST_REJECTED', 'Dock Request Rejected'
...
class LotStatus(models.TextChoices):
    ...
    DRAFT = 'DRAFT', 'Draft'
    PENDING_WAREHOUSE_APPROVAL = 'PENDING_WAREHOUSE_APPROVAL', 'Pending Warehouse Approval'
    WAREHOUSE_APPROVED = 'WAREHOUSE_APPROVED', 'Warehouse Approved'
    WAREHOUSE_REJECTED = 'WAREHOUSE_REJECTED', 'Warehouse Rejected'
    EXPIRED_WAREHOUSE_APPROVAL = 'EXPIRED_WAREHOUSE_APPROVAL', 'Expired Warehouse Approval'
